...
# 引入槽函数
from example.slots.monitor.CacheSlot import CacheSlot
from example.slots.monitor.JobLogSlot import JobLogSlot
from example.slots.monitor.JobSlot import JobSlot
from example.slots.monitor.LogininforSlot import LogininforSlot
from example.slots.monitor.OnlineSlot import OnlineSlot
from example.slots.monitor.OperlogSlot import OperlogSlot
from example.slots.monitor.ServerSlot import ServerSlot
from example.slots.system.dict.DataSlot import DataSlot
from example.slots.system.dict.TypeSlot import TypeSlot
from example.slots.system.ConfigSlot import ConfigSlot
from example.slots.system.DeptSlot import DeptSlot
from example.slots.system.MenuSlot import MenuSlot
from example.slots.system.NoticeSlot import NoticeSlot
from example.slots.system.PostSlot import PostSlot
from example.slots.system.RoleSlot import RoleSlot
from example.slots.system.UserSlot import UserSlot
from example.slots.LoginSlot import LoginSlot
# 引入权限槽函数
from example.utils.Permission import Permission
