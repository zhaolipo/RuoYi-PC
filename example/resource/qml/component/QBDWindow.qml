...
Window {
    ...
    property int leftWidth: 500
    property color leftColor: Qt.rgba(32/255,32/255,32/255,1)
    ...
    property Item appBar: FluAppBar {
        ...
        RowLayout {
            ...
            // spacing: 6
            Rectangle {
                color: window.leftColor
                Layout.fillWidth: true
                Layout.fillHeight: true
                Layout.minimumWidth: window.leftWidth
                Layout.preferredWidth: window.leftWidth
                Layout.maximumWidth: window.leftWidth
            }
            Rectangle {
                Layout.fillWidth: true
            }
